/**
 * @file edging.js
 * @description Pure utility module (no Chrome APIs) used by both the content
 *              script and any Node tests. Tracks heuristics that indicate the
 *              user might be edging.
 */

/**
 * EdgingTracker holds counters that together provide a heuristic for edging.
 * Use {@link EdgingTracker#isEdging} to decide when to nudge the user.
 */
class EdgingTracker {
  constructor() {
    this.reset();
